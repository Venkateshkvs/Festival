						...
						<tr>
							...
							<table cellpadding="4" border="1">
								<tr>
									...
									<p class="style1"><strong>First Name:</strong><jstlcore:out value="  ${visitor.firstName}"></jstlcore:out></p>
								 	<p class="style1"><strong>Last Name:</strong> <jstlcore:out value="  ${visitor.lastName}"></jstlcore:out></p>
									<p class="style1"><strong>Email:</strong> <jstlcore:out  value="  ${visitor.email}"></jstlcore:out></p>
									<p class="style1"><strong>Phone Number:</strong> <jstlcore:out value="  ${visitor.phoneNumber}"></jstlcore:out></p>
									<p class="style1"><strong>Address:</strong> <jstlcore:out value="  ${visitor.address}"></jstlcore:out></p>
									</div>
									</td>
								</tr>
							</table>
