				...
				<tr>
					...
					<table align="center" border="0">
						...
						<tr>
							...
							First Name:</td><td> 
							   <input type="text" name="FIRSTNAME" size="40"></input></td> 
							
					   </tr>
					   <tr>			
							<td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
							Last Name: </td><td><input type="text" name="LASTNAME" size="40"></input></td>
							
					   </tr>
					   <tr>
							<td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
							User Name:</td><td><input type="text" name="USERNAME" size="40"></input></td> 
							
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Password:</td><td><input type="password" name="PASSWORD" size="40"></input></td>
						   
					   </tr>
					   <tr>
						    <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Confirm Password:</td><td><input type="password" name="CPASSWORD" size="40"></input></td>
						   
					   </tr>
					   <tr>
						   <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
						    Email: </td><td> <input type="text" name="EMAIL" size="50"></input></td> 
						    
					   </tr>
					   <tr>
                           <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
                           Phone Number:</td><td><input type="text" name="PHONENO" size="40"></input></td>
                           
					   </tr>
					   <tr>
						   <td> Address:</td><td> <input type="text" name="ADDRESS" size="30"></input> </td>
